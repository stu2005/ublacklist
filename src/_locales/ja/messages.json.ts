...
export default exportAsMessages({
  ...
  options_serpInfoMode: "SERPINFO モード",
  options_serpInfoModeOpenSettings: "設定",
  options_serpInfoMode_sectionTitle: "SERPINFO モード",
  options_serpInfoMode_enable: "SERPINFO モードを有効にする",
  options_serpInfoMode_enableForAll: "全ての検索エンジンで有効にする",
  options_serpInfoMode_userSerpInfo: "マイ SERPINFO",
  options_serpInfoMode_saveUserSerpInfoButton: "保存",
